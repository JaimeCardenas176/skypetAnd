...
import com.example.jaime.skypet.EncontradosFragment.OnListFragmentInteractionListener;
import com.example.jaime.skypet.models.Pet;

import java.util.List;


public class MyEncontradosRecyclerViewAdapter extends RecyclerView.Adapter<MyEncontradosRecyclerViewAdapter.ViewHolder> {

    private final List<Pet> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyEncontradosRecyclerViewAdapter(List<Pet> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_encontrados, parent, false);
